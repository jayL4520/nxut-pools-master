      ...
      <div class="row flex-box item-start"  >
        ...
        <div :span="8" class="coll_20 padLeft" style="min-width: 140px;">
          ...
          <div class="xp-box flex-box" >
            ...
            <div class="xp-label act" v-if="msgData.length">{{Number(msgData[0]&&msgData[0].plot||0).toFixed(2)||'--'}}</div>
          </div>

          <div class="xp-box flex-box" >
            <div class="names xp-name">总资产：</div>
            <div class="xp-label act">{{Number(info.money||0).toFixed(2)||'--'}}</div>
          </div>
        ...
        <div :lg="16" class="coll_80" >
          ...
          <div class=" center flex-box column marTop marBtm  padTop coll_100" v-if="state==null" >
            ...
            <svg  :class="{
              ...
              <div class="marBtm white bold">{{(state?'矿池收益':'详细流水')+(loading?' 加载中...':'')}}</div>
              </div>
