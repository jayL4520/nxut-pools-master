          ...
          <div  class="coll_100 marBtm" >
            ...
            <div class=" center center column  coll_100" >
              ...
              <div class="sqbox  center flex-box coll_100">
                ...
                <div class="titl act padTop padBtm coll_20" :class="{isSamll:['id','num','money'].indexOf(i)>-1}" v-show="['kid','type'].indexOf(i)==-1" v-for="(item,i) in $utils.keyOpt.liumsg" >{{item}}</div>
              </div>
