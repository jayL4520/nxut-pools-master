...
<template>
  ...
  <div class="poolPage"  :class="[$route.name,{pad:!isMobile}]">
      <el-row  class="row  item-start"  >
        <el-col :lg="5" :xs="24" class=" xs_pad" :class="{
          'flex-box wrap between':isMobile,
...
export default {
  ...
  data(){
    return {
      ...
      keyFor1:{ "time": 1701074848 ,  "memo": "区块分红","money": 0.0006,money:'1', "hashid": 108 },
      keyFor:{ "day": 1701074848 ,  "iconme": "区块分红","money": 0.0006,money:'1' },
      isTrue:false,
      titleS:[''],
      isMobile:false,
  ...
  mounted(opt){
    ...
    this.getData()
    this.getScreenWin()
    window.addEventListener('resize', this.getScreenWin);
  },
  beforeCreated(){
